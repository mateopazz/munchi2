...
import SimpleRecipeScreen from './Vistas/Favoritos';
import RecetaPasoAPaso from './Vistas/PasoAPaso';
import RecetaScreen from './Vistas/Receta';
        ...
        <Stack.Navigator>
          ...
          {isAuthenticated ? (
            <>
              ...
              <Stack.Screen name ="Favoritos" component={SimpleRecipeScreen}/>
              <Stack.Screen name ="PasoAPaso" component={RecetaPasoAPaso}/>
